          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/tech" className="text-indigo-600 dark:text-indigo-400 px-3 py-2 rounded-md text-sm font-medium">
                  技术文档
                </Link>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-indigo-600 dark:text-indigo-400 mb-3">技术亮点优先</h4>
                <p className="text-gray-600 dark:text-gray-300">突出 WASM/安全/AI 能力</p>
              </div>
              <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-indigo-600 dark:text-indigo-400 mb-3">闭环场景</h4>
                <p className="text-gray-600 dark:text-gray-300">完成「上传→处理→下载」完整流程</p>
              </div>
              <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-indigo-600 dark:text-indigo-400 mb-3">开发可行性</h4>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                      <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">功能</th>
                      <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">实现方案</th>
                      <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">耗时</th>
                      <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">交付物</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <td className="py-3 px-4 text-gray-900 dark:text-white">PDF → DOCX 转换</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">pdf-lib.js + WASM文本提取</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">1天</td>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      ...
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">docx-pdf (基于Puppeteer Core WASM)</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">1天</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">带基础水印的PDF</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 text-gray-900 dark:text-white">扫描件OCR (JPG→可搜PDF)</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">Tesseract.js WASM版 + 自动纠偏</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">1.5天</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">可复制文本的PDF</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      ...
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">pdf-lib文本图层叠加</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">0.5天</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">"Confidential"字样水印</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 text-gray-900 dark:text-white">身份证号检测熔断</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">正则匹配(/\d{17}[\dX]/) + 弹窗警告</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">0.5天</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">风险文档拦截功能</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <td className="py-3 px-4 text-gray-900 dark:text-white">Web Workers多线程处理</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">Comlink封装耗时操作</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">1天</td>
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">环形进度条 + 文件大小估算</td>
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">0.5天</td>
                      <td className="py-3 px-4 text-gray-600 dark:text-gray-300">用户感知等待时间</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      ...
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">0.2天</td>
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      ...
                      <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">0.3天</td>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">WASM模块</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Web Workers</h3>
                <p className="text-gray-600 dark:text-gray-300">多线程处理</p>
              </div>
            </div>
            
            <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">WASM模块组件</h4>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">日期</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">核心任务</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">里程碑</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day1</td>
                    <td className="py-3 px-4 text-gray-900 dark:text-white">PDF→DOCX转换引擎</td>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-300">完成5页测试PDF转换</td>
                  </tr>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day2</td>
                    <td className="py-3 px-4 text-gray-900 dark:text-white">DOCX→PDF+水印基础</td>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-300">生成带水印的PDF文档</td>
                  </tr>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day3</td>
                  ...
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day4</td>
                    <td className="py-3 px-4 text-gray-900 dark:text-white">Web Workers多线程架构</td>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-300">处理百页PDF时不冻结界面</td>
                  </tr>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day5</td>
                    <td className="py-3 px-4 text-gray-900 dark:text-white">安全模块(身份证检测+水印)</td>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-300">触发熔断时阻止下载</td>
                  </tr>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day6</td>
                  ...
                  <tr>
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">Day7</td>
