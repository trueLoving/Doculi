          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/product" className="text-indigo-600 dark:text-indigo-400 px-3 py-2 rounded-md text-sm font-medium">
                  产品介绍
                </Link>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">智能连接</h3>
                <p className="text-gray-600 dark:text-gray-300">像神经突触般智能连接文档处理全流程</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">毫秒级处理</h3>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">扫描件OCR</h4>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">多格式互转</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">表格数据提取</h4>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">动态DNA水印系统</h4>
                  <div className="space-y-2">
                    <p className="text-gray-600 dark:text-gray-300">
                      <strong>生物特征水印：</strong>WebAudio API捕获击键节奏 + WebGL渲染个性化噪点纹理
                    </p>
                    <p className="text-indigo-600 dark:text-indigo-400 font-semibold">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">合规性熔断机制</h4>
                  <div className="space-y-2">
                    <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">量子压缩算法</h4>
                  <div className="space-y-2">
                    <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">跨文档血缘分析</h4>
                  <div className="space-y-2">
                    <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">智能条款提取器</h4>
                  <div className="space-y-2">
                    <p className="text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">多模态批处理</h4>
                  <div className="space-y-2">
                    <p className="text-gray-600 dark:text-gray-300">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">技术领域</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">创新点数量</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">性能突破</th>
                    <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">竞争优势周期</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <td className="py-3 px-4 text-gray-900 dark:text-white">WASM优化</td>
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">7项</td>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-300">处理速度提升3-8倍</td>
                  ...
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    ...
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">5项</td>
                  ...
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    ...
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">4项</td>
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400 font-semibold">3项</td>
