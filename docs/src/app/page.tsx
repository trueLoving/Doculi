    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Doculi</h1>
              </div>
            </div>
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="/product"
                  className="border border-indigo-600 text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 px-8 py-3 rounded-lg text-lg font-semibold transition-colors"
                >
                  了解更多
                </a>
              </div>
        ...
        <section className="py-20 bg-gradient-to-r from-indigo-500 to-purple-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">适用场景</h2>
        ...
        <section className="py-20 bg-gray-900 dark:bg-gray-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">准备开始使用Doculi？</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#contact"
                className="border border-gray-600 text-gray-300 hover:bg-gray-800 px-8 py-3 rounded-lg text-lg font-semibold transition-colors"
              >
                联系销售
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">智能文档处理平台，让您的文档工作更加高效。</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <a href="/apps/web" className="hover:text-white transition-colors">
                    在线体验
                  </a>
                </li>
              </ul>
