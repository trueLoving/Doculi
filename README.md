...
Doculi 是一个创新的 Web 端文档处理平台，结合了 WebAssembly (WASM) 技术，提供高性能的文档转换、OCR 识别和安全处理。所有处理都在浏览器中完成，保护用户数据隐私。
...
### 企业办公
- **合同文档处理**：PDF 合同转换为 Word 格式便于编辑
- **报告生成**：扫描件发票转换为可搜索 PDF
- **文档安全**：添加水印保护敏感文档

### 教育培训
- **教学资料转换**：PDF 课件转换为 Word 格式便于修改
- **作业处理**：扫描件作业转换为可编辑文档
- **资料整理**：批量处理教学文档

### 个人使用
- **文档编辑**：PDF 文档转换为 Word 进行编辑
- **扫描件处理**：照片转文字，提高工作效率
- **格式统一**：不同格式文档统一处理
